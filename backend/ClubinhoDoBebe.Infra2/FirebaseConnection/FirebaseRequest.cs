...
namespace ClubinhoDoBebe.Infra.FirebaseConnection
{
    class FirebaseRequest
    {
        ...
        public FirebaseResponse Execute()
        {
            ...
            {
                return new FirebaseResponse(false, "Proided Firebase path is not a value");
            }
            ...
            if (this.JSON != null)
            {
                ...
                {
                    return new FirebaseResponse(false, string.Format("Invalid Json"));
                }
            }
